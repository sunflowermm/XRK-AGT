...
| 工作流 | `#infrastructure/ai-workflow/ai-workflow.js` | `ai-workflow/loader.js` | `core/*/stream/*.js` |
...
- `runtimeConfig.aistream` → `data/server_bots/{port}/aistream.yaml`（非 `server_bots` 根目录）。
