...
export class TaskerBase {
   ...
   * @param {string} options.id - AgentRuntime ID
   * @param {string} options.name - AgentRuntime名称
   * @param {string} options.type - tasker 类型 (onebot/device/stdin)
   * @param {Object} options.info - AgentRuntime信息
   * @param {Object} options.tasker - tasker 实例
   * @param {Object} bot - AgentRuntime主实例
   * @returns {Object} 标准化的AgentRuntime实例
   */
   ...
   * @param {string} options.self_id - AgentRuntime ID
   * @param {Object} options.data - 事件数据
   * @param {Object} bot - AgentRuntime实例
