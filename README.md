...
- **⭐ system-Core 内置模块**：11 HTTP API、7 工作流（68 MCP 工具）、15 插件、4 Tasker、3 事件监听器、Web 控制台（`/xrk/`）
...
- 想**看清目录该放哪**：阅读 [`PROJECT_OVERVIEW.md`](PROJECT_OVERVIEW.md) 的「目录结构详解」与 [`docs/README.md`](docs/README.md) 的「仓库目录速查」
...
- 想**查全部文档**：[`docs/README.md`](docs/README.md)（文档中心）
...
| 概览与运行 | [项目概览](PROJECT_OVERVIEW.md)、[底层架构设计](docs/底层架构设计.md)、[Bot](docs/bot.md)、[Server](docs/server.md)、[Docker](docs/docker.md) |
...
| 类型 | 标准值 | 验证命令 |
|------|--------|----------|
| HTTP / stream / plugin / tasker / events | 11 / 7 / 15 / 4 / 3 | `pnpm test`（59 项） |
