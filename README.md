...
- **⭐ system-Core 内置模块**：11 个 HTTP API、7 个工作流（约 68 个 MCP 工具）、4 个 Tasker、企业级 Web 控制台
...
| system-Core | [system-Core 特性文档](docs/system-core.md) ⭐ - 内置模块完整说明（11 个 HTTP API、7 个工作流、4 个 Tasker、Web 控制台） |
