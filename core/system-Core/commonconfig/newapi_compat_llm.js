        ...
        fields: {
          providers: {
            ...
            fields: {
              ...
              protocol: { type: 'string', label: '协议类型', enum: ['new-api'], default: 'new-api', component: 'Select' },
              baseUrl: { type: 'string', label: 'API 基础地址', description: 'New API / 兼容网关基础地址', default: '', component: 'Input' },
              ...
              topP: { type: 'number', label: 'Top P（top_p）', min: 0, max: 1, default: 1.0, component: 'InputNumber' },
              ...
              toolChoice: { type: 'string', label: '工具选择模式（tool_choice）', default: 'auto', component: 'Input' },
              parallelToolCalls: { type: 'boolean', label: '并行工具调用（parallel_tool_calls）', default: true, component: 'Switch' },
              ...
              headers: { 
                type: 'object', 
                label: '额外请求头',
                description: '可选：为 New API 接口追加 HTTP 头',
