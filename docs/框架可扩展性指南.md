...
flowchart TB
    subgraph Extension["扩展能力层"]
        A["插件扩展<br/>plugin基类<br/>core/*/plugin/"]
        B["工作流扩展<br/>AIStream基类<br/>core/*/stream/"]
        C["Tasker扩展<br/>协议适配器<br/>core/*/tasker/"]
        D["事件监听器扩展<br/>EventListenerBase基类<br/>core/*/events/"]
        E["HTTP API扩展<br/>HttpApi基类<br/>core/*/http/"]
        F["渲染器扩展<br/>Renderer基类<br/>src/renderers/"]
        G["配置扩展<br/>ConfigBase基类<br/>core/*/commonconfig/"]
    end
    
    subgraph Infrastructure["基础设施层"]
        I["基类库<br/>src/infrastructure/"]
        J["加载器<br/>自动发现与加载"]
        K["工具类<br/>src/utils/"]
    end
    ...
    style Extension fill:#E6F3FF,stroke:#7AA7D9,stroke-width:2px
    style Infrastructure fill:#FFE6CC,stroke:#D9A35D,stroke-width:2px
    style A fill:#E8F8E8,stroke:#6CB46C
    style B fill:#E8F8E8,stroke:#6CB46C
    style C fill:#E8F8E8,stroke:#6CB46C
    style D fill:#E8F8E8,stroke:#6CB46C
    style E fill:#E8F8E8,stroke:#6CB46C
    style F fill:#E8F8E8,stroke:#6CB46C
    style G fill:#E8F8E8,stroke:#6CB46C
```
