---
name: agent-search
description: 检索栈：OpenClaw web_search（13 提供商 + parallel-free 免费通道）、web_fetch、与 office-research 分工
---
...
- **Auto-detect**：有任一 API Key 时按 OpenClaw 顺序自动选用；**无 Key 时默认 `parallel-free`**，失败回退 `duckduckgo`
